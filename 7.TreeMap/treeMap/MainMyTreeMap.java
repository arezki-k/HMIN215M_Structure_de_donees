...
public class MainMyTreeMap {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------------------------------------34--------------Hérault-------------------------");
		System.out.println(mhm.get("35"));  // je ne comprends pas porquoi le 35 n'affiche pas !!! il n'existe pas ?  null
		...
		System.out.println("Il y a : " + mhm.nbFeuilles()+ " feuilles.");		
	}
}
